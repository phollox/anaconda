...
enum {
    SDL_AMOTION_EVENT_AXIS_X = 0,
    SDL_AMOTION_EVENT_AXIS_Y = 1,
    SDL_AMOTION_EVENT_AXIS_PRESSURE = 2,
    SDL_AMOTION_EVENT_AXIS_SIZE = 3,
    SDL_AMOTION_EVENT_AXIS_TOUCH_MAJOR = 4,
    SDL_AMOTION_EVENT_AXIS_TOUCH_MINOR = 5,
    SDL_AMOTION_EVENT_AXIS_TOOL_MAJOR = 6,
    SDL_AMOTION_EVENT_AXIS_TOOL_MINOR = 7,
    SDL_AMOTION_EVENT_AXIS_ORIENTATION = 8,
    SDL_AMOTION_EVENT_AXIS_VSCROLL = 9,
    SDL_AMOTION_EVENT_AXIS_HSCROLL = 10,
    SDL_AMOTION_EVENT_AXIS_Z = 11,
    SDL_AMOTION_EVENT_AXIS_RX = 12,
    SDL_AMOTION_EVENT_AXIS_RY = 13,
    SDL_AMOTION_EVENT_AXIS_RZ = 14,
    SDL_AMOTION_EVENT_AXIS_HAT_X = 15,
    SDL_AMOTION_EVENT_AXIS_HAT_Y = 16,
    SDL_AMOTION_EVENT_AXIS_LTRIGGER = 17,
    SDL_AMOTION_EVENT_AXIS_RTRIGGER = 18,
    SDL_AMOTION_EVENT_AXIS_THROTTLE = 19,
    SDL_AMOTION_EVENT_AXIS_RUDDER = 20,
    SDL_AMOTION_EVENT_AXIS_WHEEL = 21,
    SDL_AMOTION_EVENT_AXIS_GAS = 22,
    SDL_AMOTION_EVENT_AXIS_BRAKE = 23,
    SDL_AMOTION_EVENT_AXIS_DISTANCE = 24,
    SDL_AMOTION_EVENT_AXIS_TILT = 25,
    SDL_AMOTION_EVENT_AXIS_GENERIC_1 = 32,
    SDL_AMOTION_EVENT_AXIS_GENERIC_2 = 33,
    SDL_AMOTION_EVENT_AXIS_GENERIC_3 = 34,
    SDL_AMOTION_EVENT_AXIS_GENERIC_4 = 35,
    SDL_AMOTION_EVENT_AXIS_GENERIC_5 = 36,
    SDL_AMOTION_EVENT_AXIS_GENERIC_6 = 37,
    SDL_AMOTION_EVENT_AXIS_GENERIC_7 = 38,
    SDL_AMOTION_EVENT_AXIS_GENERIC_8 = 39,
    SDL_AMOTION_EVENT_AXIS_GENERIC_9 = 40,
    SDL_AMOTION_EVENT_AXIS_GENERIC_10 = 41,
    SDL_AMOTION_EVENT_AXIS_GENERIC_11 = 42,
    SDL_AMOTION_EVENT_AXIS_GENERIC_12 = 43,
    SDL_AMOTION_EVENT_AXIS_GENERIC_13 = 44,
    SDL_AMOTION_EVENT_AXIS_GENERIC_14 = 45,
    SDL_AMOTION_EVENT_AXIS_GENERIC_15 = 46,
    SDL_AMOTION_EVENT_AXIS_GENERIC_16 = 47,
};
...
static int
axiscode_to_SDL(int axiscode)
{
    int axis;
    switch (axiscode) {
        case SDL_AMOTION_EVENT_AXIS_X:
            axis = SDL_CONTROLLER_AXIS_LEFTX;
            break;
        case SDL_AMOTION_EVENT_AXIS_Y:
            axis = SDL_CONTROLLER_AXIS_LEFTY;
            break;
        case SDL_AMOTION_EVENT_AXIS_Z:
            axis = SDL_CONTROLLER_AXIS_RIGHTX;
            break;
        case SDL_AMOTION_EVENT_AXIS_RZ:
            axis = SDL_CONTROLLER_AXIS_RIGHTY;
            break;
        case SDL_AMOTION_EVENT_AXIS_BRAKE:
        case SDL_AMOTION_EVENT_AXIS_RX:
            axis = SDL_CONTROLLER_AXIS_TRIGGERLEFT;
            break;
        case SDL_AMOTION_EVENT_AXIS_GAS:
        case SDL_AMOTION_EVENT_AXIS_RY:
...
int
Android_OnJoy(int device_id, int axiscode, float value)
{
    int axis = axiscode_to_SDL(axiscode);
    if (axis < 0)
        return -1;
