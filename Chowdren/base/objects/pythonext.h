...
public:
    ...
    void run_string(chowstring str);
    ...
    static PyObject * create_object(const chowstring & v);
    static PyObject * create_object(int value);
    static PyObject * eval(chowstring str);
    static double list_append(double listd, PyObject * value);
    static double create_list();
    void call_global(const chowstring & name);
    chowstring as_string(PyObject * v);
    int as_number(PyObject * v);
    chowstring as_string(double v);
};
